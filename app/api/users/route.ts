...
export async function PATCH(req: NextRequest) {
    try {
        ...
        const { selectedPlan, values } = data;
        ...
        const updateData = {
            ...
            ...(selectedPlan && {
                role: selectedPlan === "Pro" ? "INSTRUCTOR" : selectedPlan === "Enterprise" ? "BUSINESSOWNER" : "STUDENT",
                coursesLimit: selectedPlan === "Pro" ? 200 : selectedPlan === "Enterprise" ? 500 : 5,
            }),
        };
